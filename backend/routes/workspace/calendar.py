...
async def get_calendars(body: ToolInvokeRequest, user: CurrentUser) -> ResponseEnvelope:
    return _invoke("calendar.get_calendars_info", body)


@router.post("/events/search")
async def search_events(body: ToolInvokeRequest, user: CurrentUser) -> ResponseEnvelope:
    return _invoke("calendar.search_events", body)


@router.post("/events/create")
async def create_event(body: ToolInvokeRequest, user: CurrentUser) -> ResponseEnvelope:
    return _invoke("calendar.create_event", body)


@router.post("/events/update")
async def update_event(body: ToolInvokeRequest, user: CurrentUser) -> ResponseEnvelope:
    return _invoke("calendar.update_event", body)


@router.post("/events/move")
async def move_event(body: ToolInvokeRequest, user: CurrentUser) -> ResponseEnvelope:
    return _invoke("calendar.move_event", body)


@router.post("/events/delete")
async def delete_event(body: ToolInvokeRequest, user: CurrentUser) -> ResponseEnvelope:
    return _invoke("calendar.delete_event", body)


@router.post("/datetime")
async def get_datetime(body: ToolInvokeRequest, user: CurrentUser) -> ResponseEnvelope:
